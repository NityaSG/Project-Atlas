...
import pandas as pd
column_name = 'PTs'
dme=medical_conditions = [
    "Acute hepatic failure", "Acute kidney injury", "Agranulocytosis", "Anaphylactic reaction","Anaphylactic shock", "Anaphylactoid reaction", "Anaphylactoid shock", "Angioedema",
    "Aplasia pure red cell", "Aplastic anaemia", "Autoimmune haemolytic anaemia","Autoimmune hepatitis", "Autoimmune pancreatitis", "Azotaemia", "Blindness","Bone marrow failure", "Deafness", "Deafness neurosensory", "Deafness permanent","Deafness transitory", "Dermatitis exfoliative", "Dermatitis exfoliative generalised",
    "Drug reaction with eosinophilia and systemic symptoms", "Drug-induced liver injury",
    "Erythema multiforme", "Febrile neutropenia", "Granulocytopenia", "Haemolysis",
    "Haemolytic anaemia", "Hepatic failure", "Hepatic infarction", "Hepatic necrosis",
    "Hepatitis fulminant", "Immune thrombocytopenia", "Intestinal perforation",
    "Ischaemic pancreatitis", "Neutropenic colitis", "Neutropenic infection", "Neutropenic sepsis",
    "Oedematous pancreatitis", "Optic ischaemic neuropathy", "Pancreatitis", "Pancreatitis acute",
    "Pancytopenia", "Product contamination microbial", "Progressive multifocal leukoencephalopathy",
    "Pulmonary arterial hypertension", "Pulmonary fibrosis", "Pulmonary hypertension",
    "Renal failure", "Reye's syndrome", "Rhabdomyolysis", "Stevens-Johnson syndrome",
    "Sudden cardiac death", "Sudden hearing loss", "Sudden visual loss",
    "Thrombotic thrombocytopenic purpura", "Torsade de pointes", "Toxic epidermal necrolysis",
    "Toxic optic neuropathy", "Transmission of an infectious agent via product", "Ventricular fibrillation"
]
